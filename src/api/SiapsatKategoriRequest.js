...
import { API_SIAPSAT_KATEGORI_GET } from "../config/api";

export const getSiapsatKategoriRequest = async () => {
  // const user = getLocalUser();
  try {
    const response = await axios.get(`${API_SIAPSAT_KATEGORI_GET}`, {
      headers: {
    ...
    return response.data.list_data.master_binsiapsat_category;
  } catch (error) {
