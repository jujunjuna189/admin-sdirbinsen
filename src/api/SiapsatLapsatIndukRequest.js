...
export const getSiapsatLapsatIndukRequest = async () => {
    // const user = getLocalUser();
    try {
        const response = await axios.get(`${API_SIAPSAT_GET}/lapsat/induk`, {
            headers: {
        ...
        return response.data.list_data.binsiapsat_lapsat_induk;
    } catch (error) {
        console.error("Error fetching items:", error);
    }
};

export const createSiapsatLapsatIndukRequest = async ({ body = {} }) => {
    // const user = getLocalUser();
    try {
        const response = await axios.post(`${API_SIAPSAT_GET}/lapsat/induk`, body, {
            headers: {
                Authorization: `bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NmhGNPK-EpJfPUZMxlhl8JUiB2u4_y9K5ozPiM3uxl4`,
...
export const deleteSiapsatLapsatIndukRequest = async ({ id = null }) => {
    // const user = getLocalUser();
    try {
        const response = await axios.delete(`${API_SIAPSAT_GET}/lapsat/induk/${id}`, {
            headers: {
                Authorization: `bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NmhGNPK-EpJfPUZMxlhl8JUiB2u4_y9K5ozPiM3uxl4`,
            },
        });
