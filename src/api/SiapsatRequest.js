...
export const getSiapsatRequest = async ({ kategori = null }) => {
  // const user = getLocalUser();
  try {
    const response = await axios.get(`${API_SIAPSAT_GET}?kategori=${kategori}`, {
      headers: {
    ...
    return response.data.list_data.binsiapsat;
  } catch (error) {
