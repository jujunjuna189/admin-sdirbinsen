    ...
    <aside className="relative w-[13rem] w-min-[13rem] w-max-[13rem] border-e bg-white">
      <div className="absolute top-0 bottom-0 left-0 right-0 overflow-y-auto">
        ...
        {getLocalUser()?.auth?.permission?.["binmat.menu"] && (
          <div className="cursor-pointer">
            <div className="flex gap-3 items-center text-sm px-4 py-3 hover:bg-slate-100" onClick={() => { setDropDown({ ...dropDown, binmat: !dropDown.binmat }); localStorage.setItem('sdirbinsen.dropDown', JSON.stringify({ ...dropDown, binmat: !dropDown.binmat })); }}>
            ...
            {/* Dub Menu */}
            <div className={`${dropDown.binmat ? 'block' : 'hidden'}`}>
              <div className="flex justify-between items-center hover:bg-slate-100 pl-[2.1rem] py-2" onClick={() => navigation("/material", { state: { category: { title: "Sistem Utama", key: 'sistem-utama' } } })}>
                <div className="flex gap-2 items-center text-sm">
                  <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M12 12m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" /><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" /></svg>
                  <span className="font-medium">Sistem Utama</span>
                </div>
              </div>
              <div className="flex justify-between items-center hover:bg-slate-100 pl-[2.1rem] py-2" onClick={() => navigation("/material", { state: { category: { title: "Sistem Pendukung", key: 'sistem-pendukung' } } })}>
                <div className="flex gap-2 items-center text-sm">
                  <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M12 12m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" /><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" /></svg>
                  <span className="font-medium">Sistem Pendukung</span>
                </div>
              </div>
              <div className="flex justify-between items-center hover:bg-slate-100 pl-[2.1rem] py-2" onClick={() => navigation("/material", { state: { category: { title: "MKB", key: 'mkb' } } })}>
                <div className="flex gap-2 items-center text-sm">
                  <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M12 12m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" /><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" /></svg>
                  <span className="font-medium">MKB</span>
                </div>
              </div>
              <div className="flex justify-between items-center hover:bg-slate-100 pl-[2.1rem] py-2" onClick={() => navigation("/material", { state: { category: { title: "Harwat", key: 'harwat' } } })}>
                <div className="flex gap-2 items-center text-sm">
                  <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M12 12m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" /><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" /></svg>
                  <span className="font-medium">Harwat</span>
                </div>
              </div>
            </div>
          </div>
        ...
        {getLocalUser()?.auth?.permission?.["siapsat.menu"] && (
          <div className="cursor-pointer">
            ...
            <div className={`${dropDown.binsiapsat ? 'block' : 'hidden'}`}>
              <div className="flex justify-between items-center hover:bg-slate-100 pl-[2.1rem] py-2" onClick={() => navigation("/siapsat", { state: { title: 'Haljol Binsat Armed', category: 'haljol' } })}>
                <div className="flex gap-2 items-center text-sm">
                  <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M12 12m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" /><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" /></svg>
                  <span className="font-medium">Haljol Binsat Armed</span>
                </div>
              </div>
              <div className="flex justify-between items-center hover:bg-slate-100 pl-[2.1rem] py-2" onClick={() => navigation("/siapsat", { state: { title: 'Data Ekko', category: 'ekko' } })}>
                <div className="flex gap-2 items-center text-sm">
                  <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M12 12m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" /><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" /></svg>
                  <span className="font-medium">Data Ekko</span>
                </div>
              </div>
              <div className="flex justify-between items-center hover:bg-slate-100 pl-[2.1rem] py-2" onClick={() => navigation("/siapsat-satgas", { state: { path: "/siapsat-satgas", title: 'Data Satuan Satgas OPS DN', category: 'satgas' } })}>
                <div className="flex gap-2 items-center text-sm">
                  <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M12 12m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" /><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" /></svg>
                  <span className="font-medium">Data Satuan Satgas OPS DN</span>
                </div>
              </div>
            </div>
          </div>
        ...
        {getLocalUser()?.auth?.permission?.["learning.menu"] && (
          <div className="cursor-pointer">
            ...
            <div className={`${dropDown.smartBook ? 'block' : 'hidden'}`}>
              <div className="flex justify-between items-center hover:bg-slate-100 pl-[2.1rem] py-2" onClick={() => navigation("/learning", { state: { title: "Alutsista Armed", category: "alutsista-armed" } })}>
                <div className="flex gap-2 items-center text-sm">
                  <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M12 12m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" /><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" /></svg>
                  <span className="font-medium text-xs">Alutsista Armed</span>
                </div>
              </div>
              <div className="flex justify-between items-center hover:bg-slate-100 pl-[2.1rem] py-2" onClick={() => navigation("/learning", { state: { title: "Tugas & Tanggung Jawab", category: "tugas-tanggung-jawab" } })}>
                <div className="flex gap-2 items-center text-sm">
                  <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M12 12m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" /><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" /></svg>
                  <span className="font-medium text-xs">Tugas {'&'} Tanggung Jawab</span>
                </div>
              </div>
              <div className="flex justify-between items-center hover:bg-slate-100 pl-[2.1rem] py-2" onClick={() => navigation("/learning", { state: { title: "Hasil Litbag", category: "hasil-litbag" } })}>
                <div className="flex gap-2 items-center text-sm">
                  <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M12 12m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" /><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" /></svg>
                  <span className="font-medium text-xs">Hasil Litbag</span>
                </div>
              </div>
              <div className="flex justify-between items-center hover:bg-slate-100 pl-[2.1rem] py-2" onClick={() => navigation("/learning", { state: { title: "Prioritas Renbut", category: "prioritas-renbut" } })}>
                <div className="flex gap-2 items-center text-sm">
                  <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M12 12m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" /><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" /></svg>
                  <span className="font-medium text-xs">Prioritas Renbut</span>
                </div>
              </div>
              <div className="flex justify-between items-center hover:bg-slate-100 pl-[2.1rem] py-2" onClick={() => navigation("/learning", { state: { title: "Program TOT & TOK", category: "program-tot-tok" } })}>
                <div className="flex gap-2 items-center text-sm">
                  <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M12 12m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" /><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" /></svg>
                  <span className="font-medium text-xs">Program TOT {'&'} TOK</span>
                </div>
              </div>
              <div className="flex justify-between items-center hover:bg-slate-100 pl-[2.1rem] py-2" onClick={() => navigation("/learning", { state: { title: "Roadmap Siapsat Armed", category: "roadmap-siapsat-armed" } })}>
                <div className="flex gap-2 items-center text-sm">
                  <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M12 12m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" /><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" /></svg>
                  <span className="font-medium text-xs">Roadmap Siapsat Armed</span>
                </div>
              </div>
              <div className="flex justify-between items-center hover:bg-slate-100 pl-[2.1rem] py-2" onClick={() => navigation("/learning", { state: { title: "Renbanglarsat Armed", category: "renbanglarsat-armed" } })}>
                <div className="flex gap-2 items-center text-sm">
                  <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M12 12m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" /><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" /></svg>
                  <span className="font-medium text-xs">Renbanglarsat Armed</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="cursor-pointer" onClick={() => navigation("/announcement")}>
          <div className="flex justify-between items-center hover:bg-slate-100 px-4 py-3">
            <div className="flex gap-3 items-center text-sm">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" className="text-red-800" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M7 10h10" /><path d="M9 14h5" /><path d="M12.4 3a5.34 5.34 0 0 1 4.906 3.239a5.333 5.333 0 0 1 -1.195 10.6a4.26 4.26 0 0 1 -5.28 1.863l-3.831 2.298v-3.134a2.668 2.668 0 0 1 -1.795 -3.773a4.8 4.8 0 0 1 2.908 -8.933a5.33 5.33 0 0 1 4.287 -2.16" /></svg>
