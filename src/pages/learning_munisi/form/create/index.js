...
import { UseLearningMunisiCreateContext } from "../../../../contexts/learning/LearningMunisiCreateContext";
import { getLocalUser } from "../../../../utils";
import { SatuanModal } from "../../../personil/component";

const LearningMunisiCreatePage = () => {
    const { navigation, element, controller, errors, onSetController, onSaveAndAdd, onSave } = UseLearningMunisiCreateContext();
    ...
    return (
        <Content element={element}>
            <div className="flex gap-2 items-center cursor-pointer" onClick={() => navigation(-1)}>
                ...
                <span className="font-semibold text-base text-slate-800">Tambah Buku Pintar - Munisi</span>
            </div>
...
export default LearningMunisiCreatePage;