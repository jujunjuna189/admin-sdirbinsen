...
import { UseLearningPejabatSatuanCreateContext } from "../../../../contexts/learning/LearningPejabatSatuanCreateContext";
import { getLocalUser } from "../../../../utils";
import { SatuanModal } from "../../../personil/component";

const LearningPejabatSatuanCreatePage = () => {
    const { navigation, element, controller, errors, onSetController, onSaveAndAdd, onSave } = UseLearningPejabatSatuanCreateContext();
    ...
    return (
        <Content element={element}>
            <div className="flex gap-2 items-center cursor-pointer" onClick={() => navigation(-1)}>
                ...
                <span className="font-semibold text-base text-slate-800">Tambah Buku Pintar - Pejabat Satuan Armed</span>
            </div>
...
export default LearningPejabatSatuanCreatePage;