...
import { UseLearningPejabatSatuanContext } from "../../contexts/learning/LearningPejabatSatuanContext";
import { dateFormatterV4 } from "../../utils";

const LearningPejabatSatuanPage = () => {
    const { navigation, element, category, categoryActive, learning, onShowConfirmDelete, onTabSwitch } = UseLearningPejabatSatuanContext();
        ...
        <Content element={element}>
            <div className="flex flex-wrap justify-between items-center">
                <div className="flex flex-col leading-3">
                    <span className="font-bold text-xl text-slate-800">Daftar Pejabat Satuan Armed</span>
                    <span>Buku Pintar</span>
                </div>
                <div>
                    <Button className="bg-red-800 text-white cursor-pointer" onClick={() => navigation(`/learning/pejabat-satuan/create/${categoryActive.key}`)}>
...
export default LearningPejabatSatuanPage;