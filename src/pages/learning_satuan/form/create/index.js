...
import { UseLearningSatuanCreateContext } from "../../../../contexts/learning/LearningSatuanCreateContext";
import { getLocalUser } from "../../../../utils";
import { SatuanModal } from "../../../personil/component";

const LearningSatuanCreatePage = () => {
    const { navigation, element, controller, errors, onSetController, onSaveAndAdd, onSave } = UseLearningSatuanCreateContext();
    ...
    return (
        <Content element={element}>
            <div className="flex gap-2 items-center cursor-pointer" onClick={() => navigation(-1)}>
                ...
                <span className="font-semibold text-base text-slate-800">Tambah Buku Pintar - Lambang dan Sejarah Satuan</span>
            </div>
...
export default LearningSatuanCreatePage;