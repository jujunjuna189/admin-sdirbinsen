...
import { UseLearningSatuanContext } from "../../contexts/learning/LearningSatuanContext";
import { dateFormatterV4 } from "../../utils";

const LearningSatuanPage = () => {
    const { navigation, element, learning, onShowConfirmDelete } = UseLearningSatuanContext();
        ...
        <Content element={element}>
            <div className="flex flex-wrap justify-between items-center">
                <div className="flex flex-col leading-3">
                    <span className="font-bold text-xl text-slate-800">Daftar Lambang dan Sejarah</span>
                    <span>Buku Pintar</span>
                </div>
                <div>
                    <Button className="bg-red-800 text-white cursor-pointer" onClick={() => navigation(`/learning/satuan/create`)}>
...
export default LearningSatuanPage;