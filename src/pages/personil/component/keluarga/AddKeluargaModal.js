      ...
      <div className={`fixed top-0 bottom-0 left-0 right-0 flex justify-center items-center z-10 ${!isShow && "hidden"}`}>
        ...
        <div className="p-3 border rounded-lg bg-white w-96 z-10">
          <div className="leading-3">
            <span className="text-base font-medium">Tambah Riwayat Keluarga</span>
            <br />
          ...
          <div className="min-h-[25vh] flex flex-col gap-1 py-2 my-2">
            ...
            <div>
              ...
              <InputText
                className="mt-1"
                value={controller.nama_istri_atau_suami}
                error={errors.nama_istri_atau_suami}
                onChange={(value) => onSetController("nama_istri_atau_suami", value)}
                placeholder="..."
              />
            </div>
            <div>
