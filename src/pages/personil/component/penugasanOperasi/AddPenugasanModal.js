...
import { createPenugasanOperasiByPersonilRequest } from "../../../../api/PenugasanOperasiRequest";
import { Button, InputNumber, InputText } from "../../../../components";

const AddPenugasanOperasiModal = (props) => {
    const ref = useRef();
    ...
    const onSave = async () => {
        ...
        await createPenugasanOperasiByPersonilRequest({ personil_id: props.personil_id, body: dataBatch }).then((res) => {
            ...
            <div className={`fixed top-0 bottom-0 left-0 right-0 flex justify-center items-center z-10 ${!isShow && 'hidden'}`}>
                ...
                <div className="p-3 border rounded-lg bg-white w-96 z-10">
                    <div className="leading-3">
                        <span className="text-base font-medium">Tambah Penugasan Operasi</span><br />
                        <small>Silahkan isi form penugasan operasi</small>
                    </div>
...
export default AddPenugasanOperasiModal;