    ...
    return (
        <div className="flex justify-center py-4 print-no-padding">
            <div className="flex flex-col gap-2">
                <div className="border rounded-lg print:hidden flex justify-between py-2 pl-4 pr-2 items-center">
                    <span className="font-semibold">Preview RH</span>
                    <Button className="border text-[12px] cursor-pointer" onClick={() => window.print()}>
