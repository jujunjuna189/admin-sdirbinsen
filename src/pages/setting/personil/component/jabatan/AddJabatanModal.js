...
import { createJabatanRequest } from "../../../../../api/JabatanRequest";
...
const AddJabatanModal = (props) => {
    ...
    const onSave = async () => {
        ...
        await createJabatanRequest({ body: dataBatch }).then((res) => {
            ...
            <div className={`fixed top-0 bottom-0 left-0 right-0 flex justify-center items-center z-10 ${!isShow && "hidden"}`}>
                ...
                <div className="p-3 border rounded-lg bg-white w-96 z-10">
                    <div className="leading-3">
                        <span className="text-base font-medium">Tambah Jabatan</span>
                        <br />
