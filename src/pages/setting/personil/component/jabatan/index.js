...
const JabatanPersonilSetting = (props) => {
                            ...
                            <tr key={index}>
                                ...
                                <td className="border-b-[1.5px] border-slate-200 pl-3 pr-5 py-2">
                                    <div className="flex gap-3 justify-end">
                                        <UpdateJabatanModal jabatan={item} onSave={() => props.onUpdate()} />
    ...
    return (
        <Card>
            <div className="mb-3 px-5 flex justify-between items-center">
                ...
                <div className="inline-block">
                    <AddJabatanModal onSave={() => props.onAdd && props.onAdd()} />
                </div>
            </div>
            <div className="overflow-x-auto">
                {Object.keys(props.jabatan).length === 0 ? <TableLoader /> : props.jabatan.data.length === 0 ? <EmptyData /> : renderTable()}
            </div>
...
export default JabatanPersonilSetting;