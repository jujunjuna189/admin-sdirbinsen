...
import { UseSiapsatBinsatLaplakgiatContext } from "../../../contexts/siapsat/SiapsatBinsatLaplakgiatContext";
import { getLocalUser } from "../../../utils";
import { BinsatNav } from "../component";

const SiapsatBinsatLaplakgiatPage = () => {
    const { navigation, element, data, onShowConfirmDelete } = UseSiapsatBinsatLaplakgiatContext();
        ...
        <Content element={element}>
            ...
            <div className="flex flex-wrap justify-between items-center">
                <div className="flex flex-col leading-3">
                    ...
                    <small>Laplakgiat</small>
                </div>
                {getLocalUser()?.auth?.permission?.["siapsat.create"] && (
                    <div>
                        <Button className="bg-red-800 text-white cursor-pointer" onClick={() => navigation('/siapsat/binsat_laplakgiat/create')}>
...
export default SiapsatBinsatLaplakgiatPage;