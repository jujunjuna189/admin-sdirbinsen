...
import { UseSiapsatBinsatRenlakgiatCreateContext } from "../../../../../contexts/siapsat/SiapsatBinsatRenlakgiatCreateContext";
import { SatuanModal } from "../../../../personil/component";

const SiapsatBinsatRenlakgiatCreatePage = () => {
  const { navigation, element, controller, errors, onSetController, onSave, onSaveAndAdd } = UseSiapsatBinsatRenlakgiatCreateContext();
  ...
  return (
    <Content element={element}>
      <div className="flex gap-2 items-center cursor-pointer" onClick={() => navigation(-1)}>
        ...
        <span className="font-semibold text-base text-slate-800">Tambah Binsat Renlakgiat</span>
      </div>
      <div className="flex justify-center">
        <div className="border rounded-lg p-3 w-full max-w-[652px]">
          <span className="text-base font-medium">Tambah Binsat Renlakgiat</span>
...
export default SiapsatBinsatRenlakgiatCreatePage;
