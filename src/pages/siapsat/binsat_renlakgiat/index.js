...
import { UseSiapsatBinsatRenlakgiatContext } from "../../../contexts/siapsat/SiapsatBinsatRenlakgiatContext";
import { getLocalUser } from "../../../utils";
import { BinsatNav } from "../component";

const SiapsatBinsatRenlakgiatPage = () => {
    const { navigation, element, data, onShowConfirmDelete } = UseSiapsatBinsatRenlakgiatContext();
        ...
        <Content element={element}>
            ...
            <div className="flex flex-wrap justify-between items-center">
                <div className="flex flex-col leading-3">
                    <span className="font-bold text-xl text-slate-800">Data Binsat</span>
                    <small>Renlakgiat</small>
                </div>
                {getLocalUser()?.auth?.permission?.["siapsat.create"] && (
                    <div>
                        <Button className="bg-red-800 text-white cursor-pointer" onClick={() => navigation('/siapsat/binsat_renlakgiat/create')}>
...
export default SiapsatBinsatRenlakgiatPage;