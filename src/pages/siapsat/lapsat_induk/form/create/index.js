...
import { UseSiapsatLapsatIndukCreateContext } from "../../../../../contexts/siapsat/SiapsatLapsatIndukCreateContext";
import { SatuanModal } from "../../../../personil/component";

const SiapsatLapsatIndukCreatePage = () => {
  const { navigation, element, controller, errors, onSetController, onSave, onSaveAndAdd } = UseSiapsatLapsatIndukCreateContext();
  ...
  return (
    <Content element={element}>
      <div className="flex gap-2 items-center cursor-pointer" onClick={() => navigation(-1)}>
        ...
        <span className="font-semibold text-base text-slate-800">Tambah Lapsat Induk</span>
      </div>
      <div className="flex justify-center">
        <div className="border rounded-lg p-3 w-full max-w-[652px]">
          <span className="text-base font-medium">Tambah Lapsat Induk</span>
...
export default SiapsatLapsatIndukCreatePage;
