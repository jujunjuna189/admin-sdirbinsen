...
import { createSatuanLainLainRequest } from "../../../../api/SatuanLainLainRequest";
import { Button, InputFile, InputText } from "../../../../components";

const AddLainLainSatuanModal = (props) => {
    const ref = useRef();
    ...
    const onSave = async () => {
        ...
        await createSatuanLainLainRequest({ body: dataBatch }).then((res) => {
            ...
            <div className={`fixed top-0 bottom-0 left-0 right-0 flex justify-center items-center z-10 ${!isShow && "hidden"}`}>
                ...
                <div className="p-3 border rounded-lg bg-white w-96 z-10">
                    <div className="leading-3">
                        <span className="text-base font-medium">Tambah Data Lain Lain</span>
                        <br />
                        <small>Silahkan isi form data lain lain</small>
                    </div>
...
export default AddLainLainSatuanModal;
