...
const UpdateLainLainSatuanModal = (props) => {
    ...
    const onGetSatuanLainLain = async () => {
        await getSatuanLainLainDetailRequest({ id: props.item.id }).then((res) => {
            setController({
            ...
            <div className={`fixed top-0 bottom-0 left-0 right-0 flex justify-center items-center z-10 ${!isShow && "hidden"}`}>
                ...
                <div className="p-3 border rounded-lg bg-white w-96 z-10">
                    <div className="leading-3">
                        <span className="text-base font-medium">Ubah Data Lain Lain</span>
                        <br />
...
export default UpdateLainLainSatuanModal;
