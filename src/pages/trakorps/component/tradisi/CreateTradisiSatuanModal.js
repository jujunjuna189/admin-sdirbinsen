...
const CreateTradisiSatuanModal = (props) => {
    ...
    const onSave = async () => {
        ...
        await createSatuanTradisiRequest({ body: dataBatch }).then((res) => {
        ...
        <div className="inline-block" ref={ref}>
            <div className="cursor-pointer" onClick={() => toogleModal()}>
                <div className="flex gap-3 items-center text-slate-600">
                    <Button className="border border-red-800 bg-red-800 text-white flex justify-center py-[0.35rem]">Tambah</Button>
                </div>
            </div>
            <div className={`fixed top-0 bottom-0 left-0 right-0 flex justify-center items-center z-10 ${!isShow && "hidden"}`}>
                ...
                <div className="p-3 border rounded-lg bg-white w-96 z-10">
                    <div className="leading-3">
                        <span className="text-base font-medium">Tambah Tradisi Satuan</span>
                        <br />
...
export default CreateTradisiSatuanModal;
